 ...
 *
 * The modulepreload hints for eager islands are emitted inline next to each
 * marker by `renderVueComponent`, not here — that keeps them order-independent
 * (islands rendered after this block are still covered) and lets header islands
 * advertise their chunks early.
 *
